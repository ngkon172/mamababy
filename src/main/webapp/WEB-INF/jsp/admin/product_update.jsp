  ...
  <form action="/admin/product_upload" method="post" enctype="multipart/form-data">
        ...
        <td>
          <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
            ...
            <tr>
              ...
              <td class="t_value" colspan="3">
                <input type="text" name="prdname" value="${item.prdname}" size="60" class="input">
              </td>
            </tr>
          </table>
        </td>
        ...
        <td>
          <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
            <tr>
              ...
              <td width="35%" class="t_value"><input name="sellprice" type="text" value="${item.sellprice}" class="input" onchange="setReserve(this.form);"></td>
            ...
            <tr>
              ...
              <td class="t_value"><input name="reserve" type="text" value="${item.reserve}" class="input"></td>
              <td class="t_name">재고량</td>
              <td class="t_value">
                수량
                <input name="stock" type="text" size="5" value="${item.stock}" class="input">개<br>
          ...
          <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
            <tr>
              ...
              <td width="85%" class="t_value" colspan="3">
                옵션명 : <input type="text" name="opttitle1" value="${item.opttitle1}" size="12" class="input">
                &nbsp; 옵션 : <input type="text" name="optcode1" value="${item.optcode1}" size="40" class="input">
                옵션은 컴마(,)로 구분
              </td>
            </tr>
            <tr>
              ...
              <td class="t_value" colspan="3">
                옵션명 : <input type="text" name="opttitle2" value="${item.opttitle2}" size="12" class="input">
                &nbsp; 옵션 : <input type="text" name="optcode2" value="${item.optcode2}" size="40" class="input">
                ex(95,100,105...)
              </td>
            </tr>
            <tr>
              ...
              <td class="t_value" colspan="3">
                옵션명 : <input type="text" name="opttitle3" value="${item.opttitle3}" size="12" class="input">
                &nbsp; 옵션 : <input type="text" name="optcode3" value="${item.optcode3}" size="40" class="input">
      ...
      <tr>
        <td width="75%">
          <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
            ...
            <tr>
              <td height="40">상품이미지</td>
              <td  class="thumb" ><img  style="width: 100px; height: auto;"src="${item.filePath}"> </td>
            </tr>
            <!--<tr>
    ...
    <table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td >
          <textarea id="content"  name="content" rows="10" cols ="20">${item.contents}</textarea>
        </td>
      </tr>
    </table>
